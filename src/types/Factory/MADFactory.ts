...
export declare namespace Types {
  export type CreateCollectionParamsStruct = {
    ...
    tokenSalt: PromiseOrValue<BytesLike>;
  ...
  export type CreateSplitterParamsStruct = {
    splitterSalt: PromiseOrValue<BytesLike>;
    ambassador: PromiseOrValue<string>;
    project: PromiseOrValue<string>;
    ambassadorShare: PromiseOrValue<BigNumberish>;
    projectShare: PromiseOrValue<BigNumberish>;
  };
...
export interface MADFactoryInterface extends utils.Interface {
  functions: {
    ...
    "createCollection((uint8,bytes32,string,string,uint256,uint256,string,address,uint96))": FunctionFragment;
    "createSplitter((bytes32,address,address,uint256,uint256))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [Types.CreateCollectionParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "createSplitter",
    values: [Types.CreateSplitterParamsStruct]
  ): string;
  encodeFunctionData(
