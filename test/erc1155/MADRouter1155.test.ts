...
describe("MADRouter1155", () => {
  ...
  describe("Set URI", async () => {
    // not possible since we only accept basic nfts at the moment
  ...
  describe("Creator Withdraw", async () => {
    it("Should withdraw balance and ERC20 for all colTypes", async () => {
      ...
      await basic2.connect(acc01).mint(1, 1, { value: price.add(ethers.utils.parseEther("0.25")) });
