...
contract MADMarketplace721 is
    ...
    ERC721Holder
{
    using ContractTypes for ContractTypes.Order721;
    ...
    mapping(bytes32 => ContractTypes.Order721) public orderInfo;
    ...
    function bid(bytes32 _order) public payable {
        ContractTypes.Order721 storage order = orderInfo[_order];
    ...
    function _makeOrder(
        ...
        orderInfo[hash] = ContractTypes.Order721(
            _id,
            _startPrice,
            _endPrice,
            block.timestamp,
    ...
    function _intPath(
        ContractTypes.Order721 storage _order,
        uint256 _price,
        bytes32 _orderId,
        address _to,
        uint256 key
