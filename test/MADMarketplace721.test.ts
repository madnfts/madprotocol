...
describe("MADMarketplace721", () => {
  ...
  //     console.log('Got order info', orderInfo)
  //     console.log('blocktimestamp is', blockTimestamp)
  ...
  //       startPrice: price,
  //       endPrice: zero,
  //       startTime: ethers.BigNumber.from(fpBn),
  //       endTime: ethers.BigNumber.from(300),
  //       lastBidPrice: zero,
  //       lastBidder: dead,
  //       isSold: true,
  //     };
  ...
  //       startPrice: price,
  //       endPrice: zero,
  //       startTime: ethers.BigNumber.from(daBn),
  //       endTime: ethers.BigNumber.from(300),
  //       lastBidPrice: zero,
  //       lastBidder: dead,
  //       isSold: true,
  ...
  //     // simulate DA pricing math with ts
  //     const delta = ethers.BigNumber.from(blockTimestamp + 301 - daBn);
  //     // tick = (startPrice(price) - endPrice(0)) / (endBlock - startBlock)
  //     const tick = price.div(delta);
  //     // 202 - 33 = 169
  //     const dec = ethers.BigNumber.from(169).mul(tick);
  ...
  //       startPrice: price,
  //       endPrice: zero,
  //       startTime: ethers.BigNumber.from(eaBn),
  //       endTime: ethers.BigNumber.from(600),
  //       lastBidPrice: bidVal,
  ...
  describe("Price Fetch", async () => {
    it("Should fetch order's current price", async () => {
      ...
      // simulate DA pricing math with ts
      console.log(blockTimestamp2 - orderInfo.startTime.toNumber(), blockTimestamp2)
      const delta = orderInfo.endTime.sub(orderInfo.startTime);
      const tick = price.div(delta);
      console.log(delta, tick, price)
      const dec = ethers.BigNumber.from(blockTimestamp2 - orderInfo.startTime.toNumber()).mul(tick);
      const daPrice = price.sub(dec);

      console.log(await m721.callStatic.getCurrentPrice(daOrderId), daPrice)
