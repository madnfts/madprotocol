...
// import {
//   minimalFixture1155ERC20, // erc20Fixture,
// } from "./../../utils/fixtures";
// import {
//   ERC165Interface,
//   ERC1155Interface,
...
//       await erc20
//         .connect(acc02)
//         .approve(minimal.address, 10100111001);
//       await expect(
//         minimal.connect(acc02).publicMint(1),
//       ).to.be.revertedWithCustomError(
//         minimal,
...
//         .connect(acc02)
//         .approve(minimal.address, price);
//       await minimal.connect(acc02).publicMint(1);
...
//       await expect(
//         minimal.connect(acc01).withdrawERC20(erc20.address, ethers.constants.AddressZero),
//       ).to.be.revertedWith(MinimalErrors.Unauthorized);
//     });
